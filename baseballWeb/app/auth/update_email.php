...
if ($success) {
    ...
    $mailSent = sendMail(
        $newEmail,
        "Your 2D Baseball email has been changed",
        "
        <!DOCTYPE html>
        <html lang='en'>
        <head>
        ...
        <body>
            <div class='email-container'>
                ...
                <div class='content'>
                    ...
                    <p>Your email has been successfully changed from {$currentUser['email']} to $newEmail.</p>
    ...
    if (!$mailSent) {
        echo json_encode([
            'success' => true,
            'email' => $newEmail,
            'warning' => 'Email updated but confirmation email could not be sent'
        ]);
    } else {
